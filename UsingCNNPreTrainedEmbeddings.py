...
class PreTrained_Embedding:
    ...
    def plot(self):
        ...
        plt.legend()
        plt.show()
        plt.savefig('cnn_Training_Validation_Generic_PreWE.png')
    ...
    def tsne_plot(self):
        ...
        for i in range(len(x)):
            ...
            plt.annotate(labels[i],
                     ...
                     va='bottom')
        plt.show()
        plt.savefig('CNN_Word_Embedding_Pre.png')
        

        
        
        
p_embedding = PreTrained_Embedding()
p_embedding.load_data()
p_embedding.Tokenize()
p_embedding.Train_Build_Model()
p_embedding.execute()
p_embedding.plot()
p_embedding.tsne_plot()